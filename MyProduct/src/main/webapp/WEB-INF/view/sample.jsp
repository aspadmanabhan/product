...
<td>
	...
	<a href="viewdata?&pr={{a.name}}&pi={{a.price}}&q={{a.quantity}}" class="btn btn-info">View</a>|<a href='edit' class="btn btn-info">edit</a>|<a href='delete' class="btn btn-info">delete</a>
