...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
   ...
   <li><a href="#">Hello <% com.ecom.USER_AUTHENTICATION u=(com.ecom.USER_AUTHENTICATION)request.getAttribute("u");
...
session.setAttribute("user", u);
   ...
   %></a></li>
      ...
      <li><a href="ViewAll">Contact Us</a></li>
      
   <security:authorize access="hasRole ('ROLE_ADMIN')">
      <li><a href="addpc" data-toggle="modal" data-target="#myModal">Add a product</a></li>
